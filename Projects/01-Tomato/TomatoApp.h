...
#include "strategies/CreditCardStrategy.h"
...
public:
    ...
    void initializeRestaurants() {
        Restaurant* restaurant1 = new Restaurant("Kaka Halwai", "Pune");
        restaurant1->addMenuItem(MenuItem("P1", "Chole Bhature", 120));
        restaurant1->addMenuItem(MenuItem("P2", "Samosa", 15));

        Restaurant* restaurant2 = new Restaurant("Haldirams", "Nagpur");
        ...
        Restaurant* restaurant3 = new Restaurant("Annapurna", "Chennai");
    ...
    Order* checkoutScheduled(User* user, const string& orderType, PaymentStrategy* paymentStrategy) {
        return checkout(user, orderType, paymentStrategy, new NowOrderFactory);
    }
